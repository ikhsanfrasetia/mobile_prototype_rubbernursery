 ...
 * Master Baseline Current - SIGMA Rubber Nursery (LOCKED)
 * Single Source of Truth for Process Mapping Runtime
 * Consolidated on: 08 September 2026
 */
...
export const PROCESS_MAPPING_BASELINE = {
  "metadata": {
    ...
    "description": "SIGMA Rubber Nursery Process Mapping Store - Master Baseline Current Locked"
  },
  "roles": [
    {
      "id": "mantri-bibitan",
      "name": "Mantri Bibitan",
      "status": "Confirmed",
      "desc": "Pelaksana dan pencatat utama seluruh transaksi operasional pembibitan karet di lapangan."
    },
    {
      "id": "asisten-bibitan",
      "name": "Asisten Bibitan",
      "status": "Confirmed",
      "desc": "Verifikator lapangan dan pengawas teknis mutu operasional pembibitan karet."
    },
    {
      "id": "asisten-divisi",
      "name": "Asisten Divisi",
      "status": "Confirmed",
      "desc": "Pemohon bibit untuk kebutuhan penanaman di divisi/kebun sendiri."
    },
    {
      "id": "asisten-kepala",
      "name": "Asisten Kepala",
      "status": "Confirmed",
      "desc": "Otorisator dan penyetuju permohonan pengeluaran bibit dan tata kelola pembibitan."
    },
    {
      "id": "pengurus",
      "name": "Pengurus Kebun Peminta",
      "status": "Confirmed",
      "desc": "Pemohon dan penerima alokasi bibit/mata entres cross-estate (kebun sepupu)."
    },
    {
      "id": "tekniker-1",
      "name": "Tekniker I",
      "status": "Confirmed",
      "desc": "Pengawas mutu teknis agronomi pembibitan karet (Role master aktif, requirement kosong pada baseline saat ini)."
    },
    {
      "id": "ktu",
      "name": "KTU",
      "status": "Confirmed",
      "desc": "Kepala Tata Usaha / Verifikasi administrasi dan pembukuan kebun (Role master aktif, requirement kosong pada baseline saat ini)."
    }
  ],
  "commonFeatures": [
    {
  ...
  "modules": [
    ...
    },
    {
      ...
      "order": "03",
      "name": "Penyemaian",
      "subtitle": "Penyemaian Bedengan & Pembentukan Batch",
      "desc": "Proses penaburan benih ke Bedengan dinamis berdasarkan dokumen penerimaan benih dan pembentukan Batch tanpa Clone.",
      "primaryRole": "Mantri Bibitan",
      ...
      "features": [
        {
          ...
          "desc": "Pemeriksaan kelayakan benih, penaburan ke Bedengan dinamis, dan konsolidasi Batch bibitan tanpa Clone."
        }
      ]
    },
    {
      ...
      "name": "Okulasi",
      "roleId": "mantri-bibitan",
      "subtitle": "Okulasi (Grafting) & Okulasi Janda (Regrafting)",
      "desc": "Melakukan okulasi pada bibit dalam Batch menggunakan material Mata Entres dari Kebun Kayu Okulasi.",
      "status": "Confirmed",
      "primaryRole": "Mantri Bibitan",
      "relatedRole": "Asisten Bibitan (Verifikasi)",
      "features": [
        ...
        },
        {
          ...
          "desc": "Penempelan ulang mata entres pada bibit yang gagal pada pemeriksaan okulasi."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "desc": "Panen Mata Entres menghasilkan Mata Entres aktual yang siap digunakan untuk proses Okulasi (Grafting) dan Okulasi Janda (Regrafting).",
      "status": "Confirmed",
      "primaryRole": "Mantri Bibitan",
      "relatedRole": "Asisten Bibitan (Verifikasi)",
      "features": [
    ...
    },
    {
      ...
      "desc": "Stok dapat bertambah dari hasil Panen Mata Entres yang sudah terverifikasi. Stok digunakan untuk kebutuhan Okulasi (Grafting), Regrafting, permintaan, dan pengeluaran.",
      "status": "Confirmed",
      "primaryRole": "Mantri Bibitan",
    ...
    },
    {
      ...
      "desc": "Pencatatan aktivitas perawatan berbasis Heading Kerja terhadap objek Batch, Bedengan, Plot Entres, atau Blok.",
      "status": "Confirmed",
      "primaryRole": "Mantri Bibitan",
      "relatedRole": "Asisten Bibitan (Verifikasi)",
      "features": [
  ...
  "flows": {
      ...
      "presensi-supervisor": {
        ...
        "nodes": [
          ...
          },
          {
            ...
            "code": "P-001",
            "type": "process",
            "title": "Pencatatan Jam & Status Presensi Otomatis",
            "reqId": "RN-PRS-002",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-002",
            "type": "process",
            "title": "Verifikasi Biometrik Face ID",
            "reqId": "RN-PRS-003",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "FB-001",
            "type": "fallback",
            "title": "Foto Manual Fallback + Alasan",
            "reqId": "RN-PRS-005",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-003",
            "type": "process",
            "title": "Validasi GPS Radius Lokasi",
            "reqId": "RN-PRS-005",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-004",
            "type": "process",
            "title": "Pencatatan Presensi Terverifikasi",
            "reqId": "RN-PRS-006",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "END",
            "type": "end",
            "title": "Presensi Selesai - Buka Transaksi",
            "reqId": "RN-PRS-007",
            "role": "Mantri Bibitan"
          }
        ],
        "edges": [
          {
            ...
            "fromNode": "PR_START",
            "toNode": "PR_01",
            "label": "Buka Form Presensi"
          },
          {
            "id": "E_PR_02",
            "fromNode": "PR_01",
            "toNode": "PR_02",
            "label": "Mulai Verifikasi Biometrik"
          },
          {
            "id": "E_PR_03",
            "fromNode": "PR_02",
            "toNode": "PR_03",
            "label": "Biometrik Berhasil (Foto Otomatis)"
          },
          {
            "id": "E_PR_04",
            "fromNode": "PR_02",
            "toNode": "PR_FB",
            "label": "Biometrik Gagal (Fallback)"
          },
          {
            "id": "E_PR_05",
            "fromNode": "PR_FB",
            "toNode": "PR_03",
            "label": "Ambil Foto Manual + Alasan"
          },
          {
            "id": "E_PR_06",
            "fromNode": "PR_03",
            "toNode": "PR_04",
            "label": "GPS Dalam Radius Nursery (<200m)"
          },
          {
            "id": "E_PR_07",
            "fromNode": "PR_04",
            "toNode": "PR_END",
            "label": "Presensi Tervalidasi"
          }
        ]
      },
      "presensi-pekerja": {
    ...
    "03-penyemaian": {
      "semai-bedengan": {
        "title": "Flow Proses - Penyemaian Bedengan & Pembentukan Batch",
        "nodes": [
          {
            "id": "SEM_START",
            "code": "START",
            "type": "start",
            "title": "Buka Modul Penyemaian Bedengan",
            "reqId": "RN-SEM-001",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-001",
            "type": "process",
            "title": "Validasi QR Plang Bedengan Dinamis",
            "reqId": "RN-SEM-002",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-002",
            "type": "process",
            "title": "Pemeriksaan Kelayakan & Input Benih Disemai",
            "reqId": "RN-SEM-003",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "FB-001",
            "type": "fallback",
            "title": "Dokumentasi Foto Benih Reject / Afkir",
            "reqId": "RN-SEM-004",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-003",
            "type": "process",
            "title": "Penentuan Kelayakan Bahan",
            "reqId": "RN-SEM-005",
            "role": "Asisten Bibitan",
            "summary": "Pemeriksaan kelayakan bahan berdasarkan kondisi fisik aktual tanpa acuan umur semai.",
            "validation": "Kondisi fisik aktual layak.",
            "output": "Bahan siap disemai."
          },
          {
            "id": "SEM_04",
            "code": "P-004",
            ...
            "reqId": "RN-SEM-007",
            "role": "Mantri Bibitan",
            "summary": "Satu bedengan dapat memuat beberapa Batch. Clone tidak diisi pada tahap ini.",
            "input": "Transaksi penyemaian.",
            "validation": "Bedengan tersedia.",
            "output": "Batch penyemaian baru."
          },
          {
            "id": "SEM_END",
            "code": "END",
            "type": "end",
            "title": "Penyemaian Selesai - Batch Terdaftar (Perlu Diokulasi)",
            "reqId": "RN-SEM-008",
            "role": "Mantri Bibitan"
          }
        ],
        "edges": [
          {
            ...
            "fromNode": "SEM_START",
            "toNode": "SEM_01",
            "label": "Buka Form Penyemaian"
          },
          {
            "id": "E_SEM_02",
            "fromNode": "SEM_01",
            "toNode": "SEM_02",
            "label": "QR Bedengan Terverifikasi"
          },
          {
            "id": "E_SEM_03",
            "fromNode": "SEM_02",
            "toNode": "SEM_03",
            "label": "Input Benih Layak Selesai"
          },
          {
            "id": "E_SEM_04",
            "fromNode": "SEM_02",
            "toNode": "SEM_FB",
            "label": "Ada Benih Afkir/Rusak"
          },
          {
            "id": "E_SEM_05",
            "fromNode": "SEM_FB",
            "toNode": "SEM_03",
            "label": "Foto Bukti Reject Tersimpan"
          },
          {
            "id": "E_SEM_06",
            "fromNode": "SEM_03",
            "toNode": "SEM_04",
            "label": "Penaburan Disetujui Asisten"
          },
          {
            "id": "E_SEM_07",
            "fromNode": "SEM_04",
            "toNode": "SEM_END",
            "label": "Batch Terkonsolidasi"
          }
        ]
      }
    },
    "04-okulasi": {
      "grafting": {
        "title": "Flow Proses - Okulasi (Grafting)",
        "nodes": [
          {
            "id": "N_START",
            "code": "START",
            "type": "start",
            "title": "Pilih Batch Bibitan",
            "reqId": "RN-OKL-001",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-001",
            "type": "process",
            "title": "Tentukan Populasi yang Diokulasi",
            "reqId": "RN-OKL-002",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-002",
            "type": "process",
            "title": "Scan QR Batch & Validasi Fisik",
            "reqId": "RN-OKL-003",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-003",
            "type": "process",
            "title": "Pilih Material Mata Entres dari Kebun Kayu Okulasi",
            "reqId": "RN-OKL-006",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-004",
            "type": "process",
            "title": "Catat Hasil Grafting & Pekerja Pelaksana",
            "reqId": "RN-OKL-005",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-005",
            "type": "process",
            "title": "Dokumentasi Foto Ikatan Okulasi & Timestamp",
            "reqId": "RN-OKL-008",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-006",
            "type": "process",
            "title": "Kirim Pengajuan Okulasi ke Asisten Bibitan",
            "reqId": "RN-OKL-011",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-007",
            "type": "process",
            "title": "Pemeriksaan Lapangan & Verifikasi Asisten Bibitan",
            "reqId": "RN-OKL-013",
            "role": "Asisten Bibitan"
          },
          {
            ...
            "code": "END",
            "type": "end",
            "title": "Okulasi Selesai Terverifikasi (Siap Pemeriksaan)",
            "reqId": "RN-OKL-015",
            "role": "Mantri Bibitan"
          }
        ],
        "edges": [
          {
            ...
            "fromNode": "N_START",
            "toNode": "N_P001",
            "label": "Pilih Batch Perlu Diokulasi"
          },
          {
            "id": "E_OKL_02",
            "fromNode": "N_P001",
            "toNode": "N_P002",
            "label": "Tentukan Populasi Parsial/Total"
          },
          {
            "id": "E_OKL_03",
            "fromNode": "N_P002",
            "toNode": "N_P003",
            "label": "QR Valid & Bibit Siap"
          },
          {
            "id": "E_OKL_04",
            "fromNode": "N_P003",
            "toNode": "N_P004",
            "label": "Mata Entres KKO Terverifikasi"
          },
          {
            "id": "E_OKL_05",
            "fromNode": "N_P004",
            "toNode": "N_P005",
            "label": "Input Hasil Okulasi"
          },
          {
            "id": "E_OKL_06",
            "fromNode": "N_P005",
            "toNode": "N_P006",
            "label": "Ambil Foto Bukti Ikatan"
          },
          {
            "id": "E_OKL_07",
            "fromNode": "N_P006",
            "toNode": "N_P007",
            "label": "Kirim ke Antrean Verifikasi"
          },
          {
            "id": "E_OKL_08",
            "fromNode": "N_P007",
            "toNode": "N_END",
            "label": "Disetujui Asisten Bibitan"
          }
        ]
      },
      "regrafting": {
        ...
        "nodes": [
          ...
          },
          {
            ...
            "code": "P-005",
            "type": "process",
            "title": "Pilih Material Mata Entres dari Kebun Kayu Okulasi & Scan QR",
            ...
            "purpose": "Mencocokkan klon plot entres dengan klon batch tanaman yang diregrafting.",
          ...
          },
          {
            ...
            "code": "P-010",
            "type": "process",
            "title": "Catat Riwayat Penggunaan Mata Entres",
            ...
            "output": "Riwayat penggunaan tercatat tanpa pemotongan stok otomatis.",
            "relatedRole": "Asisten Bibitan",
      ...
      "entres-menunas": {
        ...
        "nodes": [
          ...
          },
          {
            ...
            "purpose": "Memindai QR Code plot kebun entres untuk memastikan identitas plot dan klon.",
          ...
          },
          {
            ...
            "summary": "Plot kebun entres telah ditunas dan siap untuk siklus panen mata entres berikutnya.",
            "reqId": "RN-ENT-007",
            "role": "Mantri Bibitan",
            "module": "Kebun Entres",
            "feature": "Menunas Plot Entres",
            "processType": "Penyelesaian",
            "purpose": "Menutup sesi pencatatan pemeliharaan kebun entres.",
    ...
    "09-material-bahan": {
        ...
        "nodes": [
          {
            ...
            "fallback": "Dokumen tidak dapat digunakan jika heading kerja berbeda.",
      ...
      "matching": {
        "nodes": [
          ...
          {
            "id": "MATCHING_MICRO_15",
            "title": "Pencocokan nomor BKB material gudang terhadap realisasi aplikasi pemeliharaan berbasis Heading Kerja.",
            "type": "action",
            "reqId": "RN-MAT-MMG054",
            "role": "Mantri Bibitan",
            "module": "Material & Bahan",
    ...
    "10-rekam-pemeliharaan": {
      "pemeliharaan-heading": {
        "title": "Flow Proses - Rekam Aktivitas Pemeliharaan Berbasis Heading Kerja",
        "nodes": [
          {
            "id": "MNT_START",
            "code": "START",
            "type": "start",
            "title": "Pilih Heading Kerja",
            "reqId": "RN-MNT-001",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-001",
            "type": "process",
            "title": "Pilih Objek / Lokasi Pemeliharaan",
            "reqId": "RN-MNT-002",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-002",
            "type": "process",
            "title": "Pilih Pekerja & Alokasi Target Output",
            "reqId": "RN-MNT-003",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-003",
            "type": "process",
            "title": "Pencocokan Dokumen Gudang Material",
            "reqId": "RN-MNT-004",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-004",
            "type": "process",
            "title": "Input Output Aktual & Evaluasi Jam Kerja",
            "reqId": "RN-MNT-005",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-005",
            "type": "process",
            "title": "Dokumentasi Foto Lapangan & Timestamp",
            "reqId": "RN-MNT-006",
            "role": "Mantri Bibitan"
          },
          {
            ...
            "code": "P-006",
            "type": "process",
            "title": "Verifikasi & Validasi Lapangan oleh Asisten",
            "reqId": "RN-MNT-007",
            "role": "Asisten Bibitan"
          },
          {
            ...
            "code": "END",
            "type": "end",
            "title": "Aktivitas Pemeliharaan Selesai Terverifikasi",
            "reqId": "RN-MNT-008",
            "role": "Mantri Bibitan"
          }
        ],
        "edges": [
          {
            ...
            "fromNode": "MNT_START",
            "toNode": "MNT_01",
            "label": "Pilih Heading Kerja"
          },
          {
            "id": "E_MNT_02",
            "fromNode": "MNT_01",
            "toNode": "MNT_02",
            "label": "Scan QR / Pilih Objek"
          },
          {
            "id": "E_MNT_03",
            "fromNode": "MNT_02",
            "toNode": "MNT_03",
            "label": "Alokasi Pekerja & Target"
          },
          {
            "id": "E_MNT_04",
            "fromNode": "MNT_03",
            "toNode": "MNT_04",
            "label": "Pencocokan Dokumen SPB"
          },
          {
            "id": "E_MNT_05",
            "fromNode": "MNT_04",
            "toNode": "MNT_05",
            "label": "Input Hasil & Rekomendasi HK"
          },
          {
            "id": "E_MNT_06",
            "fromNode": "MNT_05",
            "toNode": "MNT_06",
            "label": "Foto Dokumentasi & Kirim"
          },
          {
            "id": "E_MNT_07",
            "fromNode": "MNT_06",
      ...
      "pengeluaran-bibit": {
        ...
        "nodes": [
          ...
          },
          {
            ...
            "purpose": "Mendokumentasikan foto fisik bibit di atas armada angkut beserta nomor polisi sebagai bukti muat.",
  ...
  "requirements": [
    ...
    },
    {
      ...
      "moduleId": "01-presensi",
      "featureId": "presensi-supervisor",
      "deprecationReason": "Out of scope / Digantikan standar SIGMA Nursery",
      "deprecatedReason": "Requirement berstatus KONFIRMASI / hasil rekonsiliasi gap yang belum disepakati sebagai baseline aktif."
    },
    {
      "id": "RN-PRS-005",
    ...
    },
    {
      ...
      "module": "Presensi",
      "feature": "Presensi Supervisor",
      "process": "Validasi Perimeter GPS & Simpan Presensi",
      "status": "Confirmed",
    ...
    },
    {
      ...
      "module": "Presensi",
      "feature": "Presensi Supervisor",
      "process": "Gatekeeper Presensi Selesai",
      "status": "Confirmed",
    ...
    {
      "id": "RN-RCV-002",
      "title": "Mantri Bibitan memverifikasi surat jalan/BKB vendor dan mencocokkan kuantitas fisik benih kelatak.",
      "role": "Mantri Bibitan",
      "module": "Penerimaan",
      "feature": "Penerimaan Benih / Biji Kelatak",
      "process": "Verifikasi Surat Jalan & Kuantitas Fisik",
      "status": "Confirmed",
      "input": "Nomor dokumen pengeluaran gudang.",
      "validation": "Data dokumen tersedia.",
      "fallback": "Input manual jika offline.",
    ...
    },
    {
      ...
      "status": "Confirmed",
      "input": "Perhitungan fisik kotak/karung benih.",
      "validation": "Quantity mismatch tetap dapat diterima. Kondisi fisik buruk dapat dipisahkan sebagai Reject.",
      "fallback": "Catatan selisih jika ada perbedaan dengan surat jalan.",
      "output": "Kuantitas aktual tercatat.",
      "version": 1,
      "isArchived": false,
    ...
    },
    {
      ...
      "status": "Confirmed",
      "input": "Formulir penerimaan dan persetujuan Asisten.",
      "validation": "Verifikasi Asisten selesai. Koreksi quantity wajib mencatat originalValue, correctedValue, reason, correctedBy, dan correctedAt.",
      "fallback": "Pengembalian dokumen ke Mantri jika tidak cocok.",
      "output": "Dokumen penerimaan terverifikasi di database produksi.",
      "version": 1,
      "isArchived": false,
    ...
    },
    {
      ...
      "status": "Confirmed",
      "input": "Verifikasi sukses.",
      "validation": "Status Terpenuhi hanya setelah total quantity kebutuhan tercapai dan seluruh shipment diverifikasi.",
      "fallback": "-",
      "output": "Status request berubah dari Disetujui menjadi Terpenuhi.",
      "version": 1,
      "isArchived": false,
      "revisionOf": null,
      "moduleId": "02-penerimaan",
    ...
    },
    {
      ...
      "module": "Penyemaian",
      "feature": "Penyemaian ke Bedengan",
      "process": "Penentuan Kelayakan Bahan",
      "status": "Revisi",
    ...
    },
    {
      ...
      "moduleId": "03-penyemaian",
      "featureId": "semai-bedengan",
      "deprecatedReason": "Fitur Transplantasi ke Polybag dihapus dari baseline narasi M03 (Penyemaian)."
    },
    {
      "id": "RN-SEM-007",
      "title": "Pembentukan Batch Penyemaian",
      ...
      "module": "Penyemaian",
      "feature": "Penyemaian ke Bedengan",
      "process": "Pembentukan Batch Penyemaian",
      "status": "Revisi",
      "input": "Kumpulan bedengan siap digunakan untuk penyemaian",
    ...
    {
      "id": "RN-SEM-008",
      "title": "Batch telah terdaftar dan siap masuk ke proses Okulasi sesuai kondisi fisiknya.",
      "role": "Mantri Bibitan",
      "module": "Penyemaian",
      "feature": "Penyemaian ke Bedengan",
      ...
      "moduleId": "03-penyemaian",
      "featureId": "semai-bedengan",
      "requirement": "Batch telah terdaftar dan siap masuk ke proses Okulasi sesuai kondisi fisiknya."
    },
    {
      "id": "RN-OKL-000",
    ...
    },
    {
      ...
      "module": "Okulasi",
      "feature": "Grafting (Okulasi Utama)",
      "process": "Pemilihan Batch Seedling Siap Okulasi",
      "status": "Confirmed",
    ...
    },
    {
      ...
      "moduleId": "04-okulasi",
      "featureId": "grafting",
      "requirement": "Mantri memilih Batch yang akan diproses pada proses Okulasi (Grafting)."
    },
    {
      "id": "RN-OKL-003",
      ...
      "module": "Okulasi",
      "feature": "Grafting (Okulasi Utama)",
      "process": "Tampilkan Saldo Populasi & Batas Harian",
      "status": "Confirmed",
    ...
    {
      "id": "RN-OKL-004",
      "title": "Mantri Bibitan mencatat identitas Juru Okulasi, jumlah okulasi sukses, dan penggunaan entres.",
      "role": "Mantri Bibitan",
      "module": "Okulasi",
      "feature": "Grafting (Okulasi Utama)",
      "process": "Pencatatan Juru Okulasi & Realisasi Okulasi",
      "status": "Open Point",
    ...
    },
    {
      ...
      "module": "Okulasi",
      "feature": "Grafting (Okulasi Utama)",
      "process": "Validasi Kemurnian Varietas Clone",
      "status": "Revisi",
      "input": "QR Code Kebun Kayu Okulasi",
      "validation": "QR cocok dengan master clone",
    ...
    },
    {
      ...
      "module": "Okulasi",
      "feature": "Grafting (Okulasi Utama)",
      "process": "Kalkulasi Rasio Pemakaian Mata Entres",
      "status": "Confirmed",
    ...
    {
      "id": "RN-OKL-007",
      "title": "Pencatatan riwayat penggunaan Mata Entres aktual setelah verifikasi.",
      "role": "Mantri Bibitan",
      "module": "Okulasi",
      "feature": "Grafting (Okulasi Utama)",
    ...
    },
    {
      ...
      "status": "Revisi",
      "input": "Kuantitas material Mata Entres dari Kebun Kayu Okulasi",
    ...
    },
    {
      ...
      "validation": "Kuantitas aktual > 0. Estimasi bertindak sebagai referensi, bukan batasan stok otomatis.",
    ...
    {
      "id": "RN-OKL-014",
      "title": "Perekaman riwayat penggunaan material.",
      "role": "Sistem Database",
      "module": "Okulasi",
      "feature": "Grafting (Okulasi Utama)",
      ...
      "requirement": "Belum didefinisikan pada baseline.",
    ...
    {
      "id": "RN-REG-010",
      "title": "Pencatatan riwayat penggunaan material Mata Entres tanpa pemotongan stok otomatis.",
      "role": "Sistem Database",
      "module": "Okulasi",
      "feature": "Okulasi Janda / Regrafting",
    ...
    {
      "id": "RN-SEL-001",
      "title": "Hasil seleksi Mantri berstatus usulan afkir dan wajib diverifikasi fisik oleh Asisten Bibitan.",
      "role": "Mantri Bibitan",
      "module": "Penyeleksian",
      "feature": "Seleksi Kualitas Bibit Batch",
      "process": "Perekaman Usulan Seleksi Afkir Mantri",
      "status": "Confirmed",
    ...
    {
      "id": "RN-SEL-003",
      "title": "Pemindaian QR Code Batch untuk membuka form penilaian kualitas visual bibit.",
      "role": "Mantri Bibitan",
      "module": "Penyeleksian",
      "feature": "Seleksi Kualitas Bibit Batch",
      "process": "Scan QR Form Penilaian Visual Batch",
      "status": "Confirmed",
      "input": "QR Code Batch fisik.",
      "validation": "QR Batch cocok dengan data dokumen.",
      "fallback": "Pilih manual jika QR rusak.",
    ...
    {
      "id": "RN-SEL-004",
      "title": "Sistem menyajikan populasi awal, persentase keberhasilan okulasi, dan riwayat seleksi.",
      "role": "Mantri Bibitan",
      "module": "Penyeleksian",
      "feature": "Seleksi Kualitas Bibit Batch",
      "process": "Sajian Data Historis & Populasi Batch",
      "status": "Confirmed",
      "input": "Data populasi hidup terakhir.",
      "validation": "Populasi hidup > 0.",
      "fallback": "-",
    ...
    {
      "id": "RN-SEL-005",
      "title": "Mantri menginput jumlah bibit Siap Salur (Grade A), Ditunda (Under-size), dan Afkir (Mati/Cacat).",
      "role": "Mantri Bibitan",
      "module": "Penyeleksian",
      "feature": "Seleksi Kualitas Bibit Batch",
      "process": "Input Klasifikasi 3 Grade Mutu Bibit",
      "status": "Confirmed",
      "input": "Jumlah bibit reject/mati.",
      "validation": "Jumlah afkir <= populasi acuan.",
      "fallback": "Koreksi input.",
    ...
    {
      "id": "RN-MNT-001",
      "title": "Mantri Bibitan membuka form rekam pemeliharaan harian tanaman pembibitan.",
      "role": "Mantri Bibitan",
      "module": "Rekam Pemeliharaan",
      "feature": "Rekam Aktivitas Pemeliharaan",
      "process": "Buka Form Rekam Pemeliharaan Harian",
      "status": "Confirmed",
      "input": "Sesi aktif Mantri.",
      "validation": "Presensi harian selesai.",
      "fallback": "-",
    ...
    {
      "id": "RN-MNT-002",
      "title": "Memilih Master Heading Kerja pemeliharaan (Penyiraman, Penyiangan, Pemupukan, Pengendalian HPT).",
      "role": "Mantri Bibitan",
      "module": "Rekam Pemeliharaan",
      "feature": "Rekam Aktivitas Pemeliharaan",
      "process": "Pilih Master Grup Heading Pemeliharaan",
      "status": "Confirmed",
    ...
    {
      "id": "RN-MNT-003",
      "title": "Memilih target blok/bedengan/plot entres dan memindai QR Code lokasi kerja.",
      "role": "Mantri Bibitan",
      "module": "Rekam Pemeliharaan",
      "feature": "Rekam Aktivitas Pemeliharaan",
      "process": "Scan QR Lokasi Blok/Bedengan Kerja",
      "status": "Confirmed",
    ...
    {
      "id": "RN-MNT-004",
      "title": "Merekam daftar pekerja pelaksana, jam kerja, dan output volume fisik yang diselesaikan.",
      "role": "Mantri Bibitan",
      "module": "Rekam Pemeliharaan",
      "feature": "Rekam Aktivitas Pemeliharaan",
      "process": "Perekaman Tenaga Kerja & Output Fisik",
      "status": "Confirmed",
    ...
    {
      "id": "RN-MNT-005",
      "title": "Foto dokumentasi pelaksanaan aktivitas di lapangan dengan geotagging koordinat dan timestamp.",
      "role": "Mantri Bibitan",
      "module": "Rekam Pemeliharaan",
      "feature": "Rekam Aktivitas Pemeliharaan",
      "process": "Foto Geotagging Koordinat & Timestamp",
      "status": "Confirmed",
    ...
    {
      "id": "RN-MNT-006",
      "title": "Mengaitkan nomor BKB pemakaian bahan kimia/pupuk ke dalam laporan heading kerja terkait.",
      "role": "Mantri Bibitan",
      "module": "Rekam Pemeliharaan",
      "feature": "Rekam Aktivitas Pemeliharaan",
      "process": "Tautkan Nomor BKB Material ke Heading Kerja",
      "status": "Confirmed",
    ...
    {
      "id": "RN-MNT-007",
      "title": "Mengirim rekapitulasi pekerjaan harian ke Asisten Bibitan untuk approval pembebanan biaya.",
      "role": "Mantri Bibitan",
      "module": "Rekam Pemeliharaan",
      "feature": "Rekam Aktivitas Pemeliharaan",
      "process": "Kirim Rekapitulasi Pemeliharaan ke Asisten",
      "status": "Confirmed",
    ...
    {
      "id": "RN-EXP-001",
      "title": "Asisten Divisi mengajukan SPB alokasi bibit kebun sendiri yang telah disetujui Asisten Kepala.",
      "role": "Asisten Divisi",
      "module": "Pengeluaran",
      "feature": "Pengeluaran Bibit (SPB Disetujui)",
      "process": "Pengajuan SPB Bibit Kebun Sendiri",
      "status": "Confirmed",
    ...
    {
      "id": "RN-EXP-004",
      "title": "Mantri Bibitan merekam jumlah batang bibit muat dan memverifikasi nomor polisi armada pengangkut.",
      "role": "Mantri Bibitan",
      "module": "Pengeluaran",
      "feature": "Pengeluaran Bibit (SPB Disetujui)",
      "process": "Perekaman Muat Bibit & Verifikasi Armada",
      "status": "Confirmed",
      "input": "Jumlah batang bibit naik truk.",
      "validation": "Aktual <= sisa kuota SPB dan <= populasi hidup Batch.",
      "fallback": "Koreksi hitung.",
    ...
    {
      "id": "RN-RCV-KSP019",
      "title": "Mantri Bibitan mengeksekusi muat bibit kebun sepupu sesuai kuota SPB yang diteruskan Asisten.",
      "role": "Mantri Bibitan",
      "module": "Penerimaan",
      "feature": "Penerimaan Bibit - Kebun Sepupu",
      "process": "Eksekusi Muat Bibit Kebun Sepupu",
      "status": "Open Point",
      "input": "Dokumen SPB, armada angkut, dan fisik batch bibit.",
      "validation": "Jumlah bibit sesuai dokumen SPB.",
      "fallback": "Scan manual jika QR rusak.",
    ...
    {
      "id": "RN-RCV-ME025",
      "title": "Mantri Bibitan memotong dan mengemas mata entres kebun sepupu berdasarkan otorisasi Asisten.",
      "role": "Mantri Bibitan",
      "module": "Penerimaan",
      "feature": "Penerimaan Mata Entres",
      "process": "Panen & Kemas Mata Entres Kebun Sepupu",
      "status": "Open Point",
      "input": "Dokumen SPB, armada angkut, dan fisik batch bibit.",
      "validation": "Jumlah bibit sesuai dokumen SPB.",
      "fallback": "Scan manual jika QR rusak.",
    ...
    },
    {
      ...
      "module": "Material & Bahan",
      "feature": "Matching Material Dokumen Gudang",
      "process": "Pencocokan Dokumen BKB vs Realisasi Heading",
      "status": "Confirmed",
      "input": "Log mutasi sistem.",
      "validation": "Tidak boleh ada pengurangan stok manual tanpa transaksi.",
      "fallback": "Investigasi jika selisih.",
      ...
      "moduleId": "09-material-bahan",
      "featureId": "material-gudang-matching",
      "linkedNode": "MATCHING_MICRO_15"
    },
    {
      "id": "RN-MAT-MMG055",
      "title": "Menarik alokasi pupuk, herbisida, fungisida, dan plastik okulasi yang telah dikeluarkan gudang.",
      "role": "Mantri Bibitan",
      "module": "Material & Bahan",
      "feature": "Matching Material Dokumen Gudang",
      "process": "Penarikan Alokasi Bahan Gudang",
      "status": "Open Point",
      "input": "Nomor dokumen pengeluaran gudang.",
      "validation": "Dokumen gudang berstatus APPROVED.",
      "fallback": "-",
    ...
    {
      "id": "RN-MAT-MMG056",
      "title": "Validasi rekonsiliasi material memastikan kuantitas pemakaian tidak melebihi alokasi BKB.",
      "role": "Mantri Bibitan",
      "module": "Material & Bahan",
      "feature": "Matching Material Dokumen Gudang",
      "process": "Validasi Batas Maksimum Alokasi BKB",
      "status": "Open Point",
      "input": "Heading dokumen gudang vs Heading aktivitas pemeliharaan.",
      "validation": "Heading harus persis sama.",
      "fallback": "Jika tidak matching: Dokumen ditolak sistem.",
    ...
    },
    {
      ...
      "module": "Presensi",
      "feature": "Presensi Pekerja Bibitan",
      "process": "Verifikasi Presensi & HK Pekerja",
      "status": "KONFIRMASI",
      ...
      "moduleId": "01-presensi",
      "featureId": "presensi-pekerja",
      "sourceProposedId": "PROPOSED-001",
      "deprecatedReason": "Requirement berstatus KONFIRMASI / hasil rekonsiliasi gap yang belum disepakati sebagai baseline aktif."
    },
    {
      "id": "RN-MAT-MMG059",
      "title": "Approval Rekonsiliasi Dokumen Gudang Material oleh Asisten Bibitan",
      "role": "Asisten Bibitan",
      "module": "Material & Bahan",
      "feature": "Material Gudang Matching",
      "process": "Approval BKB Material",
      "status": "Deprecated",
      "input": "Nomor BKB dan bukti aplikasi lapangan.",
      "validation": "Kuantitas BKB match dengan heading kerja.",
      "fallback": "Koreksi kuantitas jika selisih.",
      "output": "Dokumen BKB disetujui resmi.",
      "version": 1,
      "isArchived": true,
      "revisionOf": null,
      "moduleId": "09-material-bahan",
      "featureId": "gudang-matching",
      "sourceProposedId": "PROPOSED-002",
      "deprecatedReason": "Requirement berstatus KONFIRMASI / hasil rekonsiliasi gap yang belum disepakati sebagai baseline aktif."
    },
    {
      "id": "RN-EXP-008",
      "title": "Plotting Polygon Lokasi Tanam Bibit & Konfirmasi Terima di Divisi",
      "role": "Asisten Divisi",
      "module": "Pengeluaran",
      "feature": "Pengeluaran Bibit SPB Disetujui",
      "process": "Plotting Polygon Tanam & Konfirmasi Terima",
      "status": "Deprecated",
      "input": "Bibit tiba di blok tanam, koordinat GPS polygon.",
      "validation": "Polygon valid dan kuantitas sesuai SPB.",
      "fallback": "Plotting ulang jika batas polygon anomali.",
      "output": "Bibit diterima resmi di divisi penanaman.",
      "version": 1,
      "isArchived": true,
      "revisionOf": null,
      "moduleId": "11-pengeluaran",
      "featureId": "pengeluaran-bibit",
      "sourceProposedId": "PROPOSED-003",
      "deprecatedReason": "Requirement berstatus KONFIRMASI / hasil rekonsiliasi gap yang belum disepakati sebagai baseline aktif."
    },
    {
      "id": "RN-SEL-012",
      "title": "Otorisasi Berita Acara Pemusnahan Bibit Afkir oleh Asisten Kepala",
      "role": "Asisten Kepala",
      "module": "Penyeleksian",
      "feature": "Seleksi Batch Polybag",
      "process": "Otorisasi Berita Acara Afkir",
      "status": "Deprecated",
      "input": "Berita acara seleksi afkir dari Asisten Bibitan.",
      "validation": "Kuantitas afkir sesuai batas toleransi teknis.",
      "fallback": "Tolak berita acara jika kuantitas janggal.",
      "output": "Otorisasi pemusnahan diterbitkan, saldo dipotong.",
      "version": 1,
      "isArchived": true,
      "revisionOf": null,
      "moduleId": "06-penyeleksian",
      "featureId": "seleksi-batch",
      "sourceProposedId": "PROPOSED-004",
      "deprecatedReason": "Requirement berstatus KONFIRMASI / hasil rekonsiliasi gap yang belum disepakati sebagai baseline aktif."
    },
    {
      "id": "RN-ENT-008",
      "title": "Audit Kemurnian Clone Tanaman Induk Entres oleh Tekniker I",
      "role": "Tekniker I",
      "module": "Kebun Entres",
      "feature": "Menunas Plot Entres",
      "process": "Audit Kemurnian Clone Entres",
      "status": "Deprecated",
      "input": "Plot entres, morfologi daun & batang.",
      "validation": "Kemurnian clone 100% bebas rogues.",
      "fallback": "Isolasi pokok jika meragukan.",
      "output": "Sertifikat kemurnian plot entres terbit.",
      "version": 1,
      "isArchived": true,
      "revisionOf": null,
      "moduleId": "07-kebun-entres",
      "featureId": "entres-menunas",
      "sourceProposedId": "PROPOSED-005",
      "deprecatedReason": "Role Tekniker I dikosongkan pada baseline saat ini (status KONFIRMASI / belum disepakati)."
    },
    {
      "id": "RN-OKL-029",
      "title": "Kalibrasi & Uji Petik Standar Juru Okulasi oleh Tekniker I",
      "role": "Tekniker I",
      "module": "Okulasi",
      "feature": "Okulasi Grafting Utama",
      "process": "Kalibrasi Standar Okulasi",
      "status": "Deprecated",
      "input": "Hasil sayatan dan ikatan okulasi juru okulasi.",
      "validation": "Ketepatan irisan mata dan standar pisau higienis.",
      "fallback": "Briefing ulang juru okulasi.",
      "output": "Hasil kalibrasi & sertifikasi juru okulasi.",
      "version": 1,
      "isArchived": true,
      "revisionOf": null,
      "moduleId": "04-okulasi",
      "featureId": "grafting",
      "sourceProposedId": "PROPOSED-006",
      "deprecatedReason": "Role Tekniker I dikosongkan pada baseline saat ini (status KONFIRMASI / belum disepakati)."
    },
    {
      "id": "RN-RCV-028",
      "title": "Uji Mutu & Daya Kecambah Benih Kelatak oleh Tekniker I",
      "role": "Tekniker I",
      "module": "Penerimaan",
      "feature": "Penerimaan Benih Kelapa Sawit",
      "process": "Uji Mutu & Daya Kecambah",
      "status": "Deprecated",
      "input": "Sampel biji kelatak dari karung vendor.",
      "validation": "Daya kecambah >= 85%, kadar air standar.",
      ...
      "moduleId": "02-penerimaan",
      "featureId": "terima-benih",
      "sourceProposedId": "PROPOSED-007",
      "deprecatedReason": "Role Tekniker I dikosongkan pada baseline saat ini (status KONFIRMASI / belum disepakati)."
    },
    {
      "id": "RN-EXP-009",
      "title": "Rekonsiliasi Buku Stok Bibitan & SPPB Bulanan oleh KTU",
      "role": "KTU",
      "module": "Pengeluaran",
      "feature": "Pengeluaran Bibit SPB Disetujui",
      "process": "Rekonsiliasi Buku Stok & SPPB",
      "status": "Deprecated",
      "input": "Rekapitulasi SPPB dan mutasi bibitan.",
      "validation": "Buku stok fisik klop dengan catatan akuntansi kebun.",
      "fallback": "Audit fisik bersama bila ada selisih.",
      "output": "Laporan bulanan mutasi bibitan terverifikasi KTU.",
      "version": 1,
      "isArchived": true,
      "revisionOf": null,
      "moduleId": "11-pengeluaran",
      "featureId": "pengeluaran-bibit",
      "sourceProposedId": "PROPOSED-008",
      "deprecatedReason": "Role KTU dikosongkan pada baseline saat ini (status KONFIRMASI / belum disepakati)."
    },
    {
      "id": "RN-MAT-MMG060",
      "title": "Audit Biaya Material & Bukti Pengeluaran Barang oleh KTU",
      "role": "KTU",
      "module": "Material & Bahan",
      "feature": "Material Gudang Matching",
      "process": "Audit Biaya Material BKB",
      "status": "Deprecated",
      "input": "Dokumen BKB dan tarif biaya material.",
      "validation": "Nilai rupiah material sesuai anggaran RKAP.",
      "fallback": "Klarifikasi ke Asisten Bibitan jika overbudget.",
      "output": "Pembebanan biaya material sah ke pembukuan estate.",
      "version": 1,
      "isArchived": true,
      "revisionOf": null,
      "moduleId": "09-material-bahan",
      "featureId": "gudang-matching",
      "sourceProposedId": "PROPOSED-009",
      "deprecatedReason": "Role KTU dikosongkan pada baseline saat ini (status KONFIRMASI / belum disepakati)."
    },
    {
      "id": "RN-PWP-007",
      ...
      "moduleId": "01-presensi",
      "featureId": "presensi-pekerja",
      "sourceProposedId": "PROPOSED-010",
      "deprecatedReason": "Role KTU dikosongkan pada baseline saat ini (status KONFIRMASI / belum disepakati)."
    },
    {
      "id": "RN-MNT-009",
      "title": "Pencatatan Audit Trail Koreksi Transaksi Pembibitan",
      "role": "Mantri Bibitan",
      "module": "Rekam Pemeliharaan",
      "feature": "Pencatatan Heading Kerja",
      "process": "Pencatatan Audit Trail Koreksi",
      "status": "Deprecated",
      "input": "originalValue, correctedValue, reason, correctedBy, correctedAt.",
      "validation": "Semua parameter audit trail wajib terisi lengkap.",
      "fallback": "Blokir penyimpanan koreksi jika parameter tidak lengkap.",
      "output": "Log audit trail tersimpan permanen dan immutable.",
      "version": 1,
      "isArchived": true,
      "revisionOf": null,
      "moduleId": "10-rekam-pemeliharaan",
      "featureId": "heading-kerja",
      "sourceProposedId": "PROPOSED-011",
      "deprecatedReason": "Requirement berstatus KONFIRMASI / hasil rekonsiliasi gap yang belum disepakati sebagai baseline aktif."
    },
    {
      "id": "RN-SEM-TP036",
      "title": "Transfer Tahap Pertumbuhan Seedling ke Okulasi oleh Asisten Bibitan",
      "role": "Asisten Bibitan",
      "module": "Penyemaian",
      "feature": "Transplanting Polybag",
      "process": "Transfer Tahap Pertumbuhan",
      "status": "Deprecated",
      "input": "Batch polybag, diameter batang seedling.",
      "validation": "Umur dan diameter siap okulasi terpenuhi.",
      "fallback": "Perpanjang masa pemeliharaan jika diameter kurang.",
      "output": "Status batch bertransisi menjadi Siap Okulasi.",
      "version": 1,
      "isArchived": true,
      "revisionOf": null,
      "moduleId": "03-penyemaian",
      "featureId": "transplanting-polybag",
      "sourceProposedId": "PROPOSED-014",
      "deprecatedReason": "Fitur Transplantasi ke Polybag dihapus dari baseline narasi M03 (Penyemaian)."
    },
    {
      "id": "RN-SEL-013",
      "title": "Verifikasi Transfer Batch Bibitan oleh Asisten Bibitan",
      "role": "Asisten Bibitan",
      "module": "Penyeleksian",
      "feature": "Seleksi Batch Polybag",
      "process": "Verifikasi Transfer Batch",
      "status": "Deprecated",
      "input": "Data pengelompokan ulang batch grade bibit.",
      "validation": "Jumlah populasi hasil transfer seimbang.",
      "fallback": "Hitung ulang jika ada selisih populasi.",
      "output": "Batch baru terdaftar dengan grade spesifik.",
      "version": 1,
      "isArchived": true,
      "revisionOf": null,
      "moduleId": "06-penyeleksian",
      "featureId": "seleksi-batch",
      "sourceProposedId": "PROPOSED-015",
      "deprecatedReason": "Requirement berstatus KONFIRMASI / hasil rekonsiliasi gap yang belum disepakati sebagai baseline aktif."
    },
    {
      "id": "RN-SEL-014",
      "title": "Pemeriksaan Berkala Stok Bibit Siap Salur vs RKAP oleh Asisten Kepala",
      "role": "Asisten Kepala",
      "module": "Penyeleksian",
      "feature": "Seleksi Batch Polybag",
      "process": "Pemeriksaan Berkala Stok Siap Salur",
      "status": "Deprecated",
      "input": "Laporan stok bibit Siap Salur (Grade A) dan jadwal tanam RKAP.",
      "validation": "Ketersediaan bibit mencukupi kebutuhan musim tanam.",
      "fallback": "Penyesuaian jadwal salur jika stok kurang.",
      "output": "Rekomendasi alokasi bibit ke divisi tanam.",
      "version": 1,
      "isArchived": true,
      "revisionOf": null,
      "moduleId": "06-penyeleksian",
      "featureId": "seleksi-batch",
      "sourceProposedId": "PROPOSED-016",
      "deprecatedReason": "Requirement berstatus KONFIRMASI / hasil rekonsiliasi gap yang belum disepakati sebagai baseline aktif."
    }
  ],
  "businessRules": [
