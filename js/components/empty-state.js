...
export const STANDARD_DOCUMENT_ICON = `<svg viewBox="0 0 24 24" width="32" height="32" stroke="#000000" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="display: block; margin: 0 auto 12px auto;"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>`;
...
export function renderEmptyStateCard({
  ...
  const defaultStyle = `background: #FFFFFF; border: 1px solid #E2E8F0; border-radius: 12px; padding: 36px 16px; text-align: center; margin-top: 10px;`;
  const styleAttr = customStyle || defaultStyle;

  return `
    <div${idAttr} style="${styleAttr}">
      ${STANDARD_DOCUMENT_ICON}
      <h3 style="font-size: 0.95rem; font-weight: 700; color: #0F172A; margin: 0 0 6px 0; line-height: 1.35;">${title}</h3>
      ${description ? `<p style="font-size: 0.78rem; color: #64748B; margin: 0; line-height: 1.45;">${description}</p>` : ''}
