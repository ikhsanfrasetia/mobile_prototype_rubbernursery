    ...
    <div class="pm-manage-bar" id="pm-manage-bar">
      ...
      ? `
          <div class="pm-manage-actions">
            <button type="button" class="pm-btn-sm pm-btn-primary" id="pm-btn-finalize-traceability" style="background:#16a34a; border-color:#15803d; font-weight:700;" title="Finalisasi seluruh Flow Edges dan Canonical Business Rule Traceability Phase 4F">
              Finalisasi Traceability
            </button>
            <button type="button" class="pm-btn-sm pm-btn-secondary" id="pm-btn-apply-true-gaps" style="font-weight:600;" title="Terapkan alur resolusi 33 True Gap ke dataset">
              Terapkan 33 True Gap
            </button>
...
function attachPortalEvents(container, store) {
  ...
  // Phase 4E/4F Actions: Finalisasi Traceability & Terapkan True Gap
  container.querySelector('#pm-btn-finalize-traceability')?.addEventListener('click', () => {
    try {
      finalizeFlowAndBusinessRuleTraceability(store);
      saveDraftToStorage();
      showToast('Traceability Phase 4F berhasil difinalisasi (187 Edges, 16/16 Rules PASS)');
      renderProcessMappingPortal(container);
    } catch (err) {
  ...
  container.querySelector('#pm-btn-apply-true-gaps')?.addEventListener('click', () => {
    try {
      ...
      saveDraftToStorage();
      showToast('33 True Gap berhasil diselesaikan (155/155 Flow Covered)');
      renderProcessMappingPortal(container);
    } catch (err) {
      ...
      <div class="pm-rtm-toolbar" style="padding: 16px 18px;">
        <div class="pm-rtm-title-area" style="margin-bottom: 12px; justify-content: space-between; width: 100%;">
          ...
          <div class="pm-trace-health-strip" style="display:flex; gap:6px; align-items:center;">
            ...
            <span class="pm-badge-confirmed" style="font-weight:700;">Rules: ${ruleReport.coveredRulesCount}/${ruleReport.totalCanonicalRules} PASS</span>
        ...
        <div class="pm-coverage-grid">
          ...
          <div class="pm-coverage-card is-warning">
            ...
            <div class="pm-cov-val-row">
              <span class="pm-cov-value" style="color:#92400e;">${ruleReport.coveredRulesCount}/${ruleReport.totalCanonicalRules}</span>
              <span class="pm-cov-pct" style="color:#92400e;">${ruleReport.coverageRate}%</span>
            </div>
            <span class="pm-cov-sub">16 Aturan Bisnis Resmi (PASS)</span>
          </div>
          ...
          <div class="pm-coverage-card is-info">
            ...
            <div class="pm-cov-val-row">
              <span class="pm-cov-value" style="color:#0369a1;">${edgeReport.totalActiveEdges}</span>
              <span class="pm-cov-pct">+${edgeReport.totalCrossFlowEdges} CF</span>
            </div>
