/**
 * scripts/run-all-tests-profile.js
 * Master Regression & Verification Test Runner for Profile Page Implementation
 */

import { execSync } from 'child_process';

const suites = [
  { name: 'Login Modal: Login Persona Modal Consistency Suite (New)', file: 'scripts/test-login-persona-modal-consistency.js' },
...
console.log('========================================================================================');
console.log('            SIGMA RUBBER NURSERY — MASTER REGRESSION RUNNER (PROFIL SAYA)               ');
console.log('========================================================================================\n');
