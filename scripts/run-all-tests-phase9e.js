/**
 * scripts/run-all-tests-phase9e.js
 * Master Regression & Verification Test Runner for Phase 9E
 */

import { execSync } from 'child_process';

const suites = [
  { name: 'Phase 9E: Persona Division Alignment (New)', file: 'scripts/test-phase9e-persona-division.js' },
...
console.log('========================================================================================');
console.log('                  SIGMA RUBBER NURSERY — MASTER REGRESSION RUNNER (PHASE 9E)            ');
console.log('========================================================================================\n');
...
for (const suite of suites) {
  try {
    ...
    const passMatches = output.match(/PASS|PASSED/g);
    // Extract actual count if reported
